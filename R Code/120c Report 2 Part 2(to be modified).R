...
source(file = "C:/Users/David/Downloads/covid-19-20201128/covid-19/data_and_functions/functions_covid19.R")
...
# 4.c.2 Lives saved from 5% reduction -------------------------------------------------------

death_toll = param_record_approx_for_beta_new[4, length(date_seq)]
death_toll

# 4.d.1 10% change in model -----------------------------------------------

###work on some simulation if the infectious period decreases
gamma_new = 1/4.5 ###suppose it changes from 5 day to 4.75 days
...
# 4.d.2 Lives saved from 10% reduction-------------------------------------------------------------------
death_toll = param_record_approx_for_beta_new[4, length(date_seq)]
death_toll
